...
{
  ASSERT_THROW (field.change_snake_direction (Direction::UP),
                std::logic_error);
  ASSERT_THROW (field.change_snake_direction (Direction::DOWN),
                std::logic_error);
  ASSERT_THROW (field.change_snake_direction (Direction::LEFT),
                std::logic_error);
  ASSERT_THROW (field.change_snake_direction (Direction::RIGHT),
                std::logic_error);
}
...
{
  field.init ();
  ASSERT_THROW (field.change_snake_direction (Direction::INVALID),
                std::logic_error);
}
